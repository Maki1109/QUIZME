...
import { AnalyticsDashboard } from '../components/AnalyticsDashboard'; // Import component biểu đồ
...
export function AnalyticsPage() {
  ...
  // Tab 'analytics' luôn được active ở trang này
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-fuchsia-50 to-indigo-50">
      ...
      <main className="py-6 px-6">
        {/* Nhúng component biểu đồ vào đây */}
        <AnalyticsDashboard />
      </main>

      {/* Floating Mascot */}
      <div className="fixed bottom-8 right-8 z-40 animate-float">
        <Mascot position="floating" size="large" emotion="thinking" />
      </div>
    </div>
  );
}